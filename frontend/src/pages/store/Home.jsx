...
console.log(order,import.meta.env.VITE_RAZORPAY_KEY_ID);
  ...
  return (
    <div className="max-w-[300px] max-h-[500px] flex-1 mx-auto mt-10 bg-white rounded-2xl shadow-lg overflow-auto border border-gray-200 transform transition-transform duration-300 hover:shadow-xl">
      ...
      <div className="p-4 space-y-4">
        {/* Title */}
        <h2 className="text-lg font-semibold text-start capitalize text-gray-800">
  ...
  <motion.button
    ...
    className="flex-1 inline-flex items-center justify-center border border-indigo-600 text-indigo-600 py-2 px-4 rounded-xl transition-all duration-300 font-medium will-change-transform  bg-white hover:bg-indigo-50"
  >
    Add to Cart
  </motion.button>
</div>
